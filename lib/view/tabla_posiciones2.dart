...
class TablaPosicionesScreen2 extends StatefulWidget {
  const TablaPosicionesScreen2({super.key});

  @override
  State<TablaPosicionesScreen2> createState() => _TablaPosicionesScreenState();
}

class _TablaPosicionesScreenState extends State<TablaPosicionesScreen2> {
